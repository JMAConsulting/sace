<?php
  ...
  define('PE_PRESENTATION_EVALUATION_PRESENTATION_METHOD', 'civicrm_1_activity_1_cg2_custom_88');
  define('TARGET_CONTACT', 'civicrm_2_contact_1_contact_existing');
  define('DEMOGRAPHIC_INFO', 'civicrm_1_activity_1_cg49_custom_1262');
