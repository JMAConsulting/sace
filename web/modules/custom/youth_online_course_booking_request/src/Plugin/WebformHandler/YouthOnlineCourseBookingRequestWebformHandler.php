...
class YouthOnlineCourseBookingRequestWebformHandler extends WebformHandlerBase {
  ...
  public function preSave(WebformSubmissionInterface $webform_submission) {
    ...
    elseif ($webform_submission_data[YOUTH_ONLINE_COURSE_BOOKING_OPTIONAL_ADDONS] === '' || $webform_submission_data[YOUTH_ONLINE_COURSE_BOOKING_OPTIONAL_ADDONS] === '0' || $webform_submission_data[YOUTH_ONLINE_COURSE_BOOKING_OPTIONAL_ADDONS] == []) {
