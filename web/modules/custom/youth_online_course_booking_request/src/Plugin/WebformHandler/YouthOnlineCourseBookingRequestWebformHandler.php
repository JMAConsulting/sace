...
namespace Drupal\youth_online_course_booking_request\Plugin\WebformHandler;
 ...
 *
 * @WebformHandler(
 *   id = "youth_online_course_booking_reqest_handler",
 *   label = @Translation("Youth Online Course Booking Reqest Handler"),
 ...
 * )
 */
class YouthOnlineCourseBookingRequestWebformHandler extends WebformHandlerBase {
  ...
  public function preSave(WebformSubmissionInterface $webform_submission) {
    ...
    if (!empty($webform_submission_data) && $webform_submission_data[YOUTH_ONLINE_COURSE_BOOKING_OPTIONAL_ADDONS] === '' || $webform_submission_data[YOUTH_ONLINE_COURSE_BOOKING_OPTIONAL_ADDONS] === '0' || $webform_submission_data[YOUTH_ONLINE_COURSE_BOOKING_OPTIONAL_ADDONS] == []) {
