jQuery(document).ready(function ($, settings) {
  ...
  $(`${drupalSettings.institutional_support_booking_update.start_date}-date, ${drupalSettings.institutional_support_booking_update.start_date}-time, ${drupalSettings.institutional_support_booking_update.end_date}-date, ${drupalSettings.institutional_support_booking_update.end_date}-time`).on('input', function () {
    var end = $(`${drupalSettings.institutional_support_booking_update.end_date}-date`).val();
    var endTime = $(`${drupalSettings.institutional_support_booking_update.end_date}-time`).val();
    var start = $(`${drupalSettings.institutional_support_booking_update.start_date}-date`).val();
    var startTime = $(`${drupalSettings.institutional_support_booking_update.start_date}-time`).val();
    if (end && start) {
