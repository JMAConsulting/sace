...
namespace Drupal\institutional_support_booking_update\Plugin\WebformHandler;
 ...
 *
 * @WebformHandler(
 *   id = "institutional_support_booking_update_handler",
 *   label = @Translation("Institutional Support Booking Update Handler"),
 *   category = @Translation("CRM"),
 *   description = @Translation("Webform Handler for adding customisation in all Institutional Support Presentation Booking update forms"),
 *   cardinality = \Drupal\webform\Plugin\WebformHandlerInterface::CARDINALITY_SINGLE,
 *   results = \Drupal\webform\Plugin\WebformHandlerInterface::RESULTS_PROCESSED,
 *   submission = \Drupal\webform\Plugin\WebformHandlerInterface::SUBMISSION_OPTIONAL,
 * )
 */
class institutionalSupportBookingUpdateWebformHandler extends WebformHandlerBase {
