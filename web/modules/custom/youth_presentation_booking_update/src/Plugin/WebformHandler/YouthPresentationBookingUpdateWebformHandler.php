...
namespace Drupal\youth_presentation_booking_update\Plugin\WebformHandler;
 ...
 *
 * @WebformHandler(
 *   id = "youth_booking_update_handler",
 *   label = @Translation("Youth Booking Update Handler"),
 *   category = @Translation("CRM"),
 *   description = @Translation("Webform Handler for adding customisation in all Youth Presentation Booking update forms"),
 *   cardinality = \Drupal\webform\Plugin\WebformHandlerInterface::CARDINALITY_SINGLE,
 *   results = \Drupal\webform\Plugin\WebformHandlerInterface::RESULTS_PROCESSED,
 *   submission = \Drupal\webform\Plugin\WebformHandlerInterface::SUBMISSION_OPTIONAL,
 * )
 */
class YouthPresentationBookingUpdateWebformHandler extends WebformHandlerBase {
