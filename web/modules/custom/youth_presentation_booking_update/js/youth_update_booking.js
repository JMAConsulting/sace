jQuery(document).ready(function ($, settings) {
  ...
  $(`${drupalSettings.youth_booking_update.start_date}-date, ${drupalSettings.youth_booking_update.start_date}-time, ${drupalSettings.youth_booking_update.end_date}-date, ${drupalSettings.youth_booking_update.end_date}-time`).on('input', function () {
    var end = $(`${drupalSettings.youth_booking_update.end_date}-date`).val();
    var endTime = $(`${drupalSettings.youth_booking_update.end_date}-time`).val();
    var start = $(`${drupalSettings.youth_booking_update.start_date}-date`).val();
    var startTime = $(`${drupalSettings.youth_booking_update.start_date}-time`).val();
    if (end && start) {
