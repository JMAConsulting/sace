...
namespace Drupal\adult_online_course_booking_update\Plugin\WebformHandler;
 ...
 *
 * @WebformHandler(
 *   id = "adult_online_course_booking_update_handler",
 *   label = @Translation("Adult Online Course Booking Update Handler"),
 *   category = @Translation("CRM"),
 *   description = @Translation("Webform Handler for fixing Adult Online Course Additional Options"),
 *   cardinality = \Drupal\webform\Plugin\WebformHandlerInterface::CARDINALITY_SINGLE,
 *   results = \Drupal\webform\Plugin\WebformHandlerInterface::RESULTS_PROCESSED,
 *   submission = \Drupal\webform\Plugin\WebformHandlerInterface::SUBMISSION_OPTIONAL,
 * )
 */
class AdultOnlineCourseBookingUpdateWebformHandler extends WebformHandlerBase {
  ...
  public function preSave(WebformSubmissionInterface $webform_submission) {
    ...
    $webform_submission_data[ADULT_ONLINE_COURSE_BOOKING_UPDATE_OPTIONAL_ADDONS] = 'None';
