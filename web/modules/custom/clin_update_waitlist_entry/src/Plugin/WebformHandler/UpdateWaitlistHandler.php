        ...
        if (!empty($webform_submission_data['add_to_waitlist']) && !empty($contactIds[2])) {
          ...
          if (!$update->first()) { // Could not update so we create a new GroupContact
            \Civi\Api4\GroupContact::create(FALSE)
              ->addValue('contact_id', $contactIds[2])
