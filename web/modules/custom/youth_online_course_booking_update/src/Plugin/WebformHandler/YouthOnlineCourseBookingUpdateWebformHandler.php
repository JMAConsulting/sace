...
namespace Drupal\youth_online_course_booking_update\Plugin\WebformHandler;
 ...
 *
 * @WebformHandler(
 *   id = "youth_online_course_booking_update_handler",
 *   label = @Translation("Youth Online Course Booking Update Handler"),
 ...
 * )
 */
class YouthOnlineCourseBookingUpdateWebformHandler extends WebformHandlerBase {
