...
namespace Drupal\wiseguyz_booking_update\Plugin\WebformHandler;
 ...
 *
 * @WebformHandler(
 *   id = "wiseguyz_booking_update_handler",
 *   label = @Translation("WiseGuyz Booking Update Handler"),
 *   category = @Translation("CRM"),
 *   description = @Translation("Webform Handler for adding customisation in all WiseGuyz Presentation Booking update forms"),
