...
namespace Drupal\community_engagement_booking_update\Plugin\WebformHandler;
 ...
 *
 * @WebformHandler(
 *   id = "community_engagement_booking_update_handler",
 *   label = @Translation("Community Engagement Booking Update Handler"),
 *   category = @Translation("CRM"),
 *   description = @Translation("Webform Handler for adding customisation in all Community Engagement Booking update forms"),
 *   cardinality = \Drupal\webform\Plugin\WebformHandlerInterface::CARDINALITY_SINGLE,
 *   results = \Drupal\webform\Plugin\WebformHandlerInterface::RESULTS_PROCESSED,
 *   submission = \Drupal\webform\Plugin\WebformHandlerInterface::SUBMISSION_OPTIONAL,
 * )
 */
class CommunityEngagementBookingUpdateWebformHandler extends WebformHandlerBase {
