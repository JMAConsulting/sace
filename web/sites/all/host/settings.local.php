...
if (!empty($databases)) {
  ...
  $civicrm_paths['civicrm.root']['url'] = 'https://'. $_ENV['VSITE_DOMAIN'].'/libraries/civicrm/core/';
...
$swarm_ips = ['10.0.0.2','10.255.0.2']; // ,10.255.0.2';
// $host_ip = '209.15.202.141';
$settings['reverse_proxy'] = TRUE;
// $conf['reverse_proxy_addresses'] = array($host_ip, $swarm_ip, $bridge_ip);
$settings['reverse_proxy_addresses'] = $swarm_ips;
$settings['reverse_proxy_header'] = 'HTTP_X_FORWARDED_FOR';

// turn off DEPRECATED for production
if (empty($_ENV['VSITE_ENVIRONMENT'])
