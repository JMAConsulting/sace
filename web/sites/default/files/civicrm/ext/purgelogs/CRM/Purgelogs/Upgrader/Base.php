 ...
 */
class CRM_Purgelogs_Upgrader_Base {

  /**
   * @var CRM_Purgelogs_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Purgelogs_Upgrader(
        'purgelogs',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Purgelogs_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Purgelogs_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
