 ...
 */
class CRM_AppointmentNotes_Upgrader_Base {

  /**
   * @var CRM_AppointmentNotes_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_AppointmentNotes_Upgrader(
        'appointment_notes',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_AppointmentNotes_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_AppointmentNotes_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
