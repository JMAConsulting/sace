 ...
 */
class CRM_AppointmentNotes_Upgrader extends CRM_AppointmentNotes_Upgrader_Base {
  ...
  public function postInstall(): void {
    ...
    $values = [
      ...
      ['value' => 'civicrm_activity', 'name' => 'Activity', 'label' => ts('Activities')],
      ['value' => 'civicrm_note', 'name' => 'Note', 'label' => ts('Notes')],
    ];
