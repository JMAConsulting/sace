 ...
 */
class CRM_Saceflags_Upgrader_Base {

  /**
   * @var CRM_Saceflags_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Saceflags_Upgrader(
        'saceflags',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Saceflags_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Saceflags_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
