 ...
 */
class CRM_Sacecustomfields_Upgrader_Base {

  /**
   * @var CRM_Sacecustomfields_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Sacecustomfields_Upgrader(
        'sacecustomfields',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Sacecustomfields_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Sacecustomfields_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
