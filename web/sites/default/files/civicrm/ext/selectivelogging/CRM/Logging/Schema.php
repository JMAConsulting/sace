...
");
    ...
    $this->tables = array_merge($this->tables, $customTables);
...
");
    ...
    //CRM_Core_Error::debug_var('logTableSpec', array_merge($this->entityCustomDataLogTables('Contact'), $this->entityCustomDataLogTables('Activity')));
  }
  ...
  public function fixSchemaDifferencesForAll(): void {
    ...
    foreach ($this->tables as $table) {
      if (empty($this->logs[$table])) {
        ...
        CRM_Core_DAO::executeQuery("DROP TABLE " . $this->logs[$table]);
