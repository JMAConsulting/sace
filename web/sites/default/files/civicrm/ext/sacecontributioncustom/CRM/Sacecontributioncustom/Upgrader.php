 ...
 */
class CRM_Sacecontributioncustom_Upgrader extends CRM_Extension_Upgrader_Base {
  ...
  public function upgrade_1001(): bool {
    $this->ctx->log->info('Applying update 1001 - Migrate Custom fields 342 (I Consent to have my name / organisation publicly reconsigsed) and custom 56 (I Prefer to make this donation anonymously) into Custom field 358');
    CRM_Core_DAO::executeQuery('UPDATE civicrm_value_contribution_3 SET consent_to_donor_recognition_1_358 = 1 WHERE consent_to_donor_recognition_342 = CONCAT(UNHEX(\'01\'), 1, UNHEX(\'01\'))');
    CRM_Core_DAO::executeQuery('UPDATE civicrm_value_contribution_3 SET consent_to_donor_recognition_1_358 = 2 WHERE consent_to_donor_recognition_342 = CONCAT(UNHEX(\'01\'), 2, UNHEX(\'01\'))');
    CRM_Core_DAO::executeQuery('UPDATE civicrm_value_contribution_3 SET consent_to_donor_recognition_1_358 = 2 WHERE i_prefer_to_make_this_donation_a_356 = CONCAT(UNHEX(\'01\'), 2, UNHEX(\'01\'))');
    return TRUE;
  }
