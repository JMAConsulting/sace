 ...
 */
class CRM_Migratepublicedbookings_Upgrader_Base {

  /**
   * @var CRM_Migratepublicedbookings_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Migratepublicedbookings_Upgrader(
        'migratepublicedbookings',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Migratepublicedbookings_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Migratepublicedbookings_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
