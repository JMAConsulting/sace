 ...
 */
class CRM_ActivityTypeProgram_Upgrader_Base {

  /**
   * @var CRM_ActivityTypeProgram_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_ActivityTypeProgram_Upgrader(
        'activity_type_program',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_ActivityTypeProgram_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_ActivityTypeProgram_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
