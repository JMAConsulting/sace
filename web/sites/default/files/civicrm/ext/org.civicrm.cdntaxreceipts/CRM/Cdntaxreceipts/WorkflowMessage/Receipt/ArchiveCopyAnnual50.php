...
class CRM_Cdntaxreceipts_WorkflowMessage_Receipt_ArchiveCopyAnnual50 extends WorkflowMessageExample {

  public function getExamples(): iterable  {
    yield [
      'name' => 'workflow/cdntaxreceipts_receipt_aggregate/ArchiveCopyAnnual50',
      'title' => "Archive copy: $50, annual",
      'tags' => ['preview'],
      'workflow' => 'cdntaxreceipts_receipt_aggregate',
    ];
  }
  ...
  public function build(array &$example): void {
    ...
    /** @var CRM_Cdntaxreceipts_WorkflowMessage_CdntaxreceiptsReceiptAggregate $messageTemplate */
