...
class CRM_Cdntaxreceipts_Page_QueuePrint extends CRM_Core_Page {
  ...
  public function run() {
    ...
    self::getAllCollectedPdf($queueId);

    // @todo should we call civiExit - what happens if nothing got sent to the browser?
    // should we call parent::run?
  }

  /**
   * Get all receipts that were created for printing and put them in a big file.
   */
  public static function getAllCollectedPdf(int $queueId): void {
