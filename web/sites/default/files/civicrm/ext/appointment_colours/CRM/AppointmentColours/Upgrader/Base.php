 ...
 */
class CRM_AppointmentColours_Upgrader_Base {

  /**
   * @var CRM_AppointmentColours_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_AppointmentColours_Upgrader(
        'appointment_colours',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_AppointmentColours_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_AppointmentColours_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
